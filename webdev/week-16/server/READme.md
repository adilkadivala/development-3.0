- http server has route, and when ever a client sent a request to server, server sent response back to the client, and this is not call persistent connection,
